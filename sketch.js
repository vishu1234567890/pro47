...
function preload(){
  ...
  batImg = loadAnimation ("assets/bat.png","assets/bat1.png","assets/bat2.png")
...
player = createSprite(displayWidth-1150, displayHeight-300, 50, 50);
 player.addImage(shooterImg)
   ...
   bat = createSprite(random(500,1100),random(100,500),20,20)
...
if((keyDown("UP_ARROW")||touches.length>0)&&player.positionY<600){
  player.y = player.y-30
}
if(keyDown("DOWN_ARROW")||touches.length>0&&player.positionY>0){
 player.y = player.y+30
}
